package com.asuka.android.asukaandroid.orm.util;
...
import com.asuka.android.asukaandroid.orm.Cache;
import com.asuka.android.asukaandroid.orm.Model;
import com.asuka.android.asukaandroid.orm.TableInfo;
import com.asuka.android.asukaandroid.orm.annotation.Column;
import com.asuka.android.asukaandroid.orm.annotation.Column.ConflictAction;
	...
	public static <T extends Model> List<T> processCursor(Class<? extends Model> type, Cursor cursor) {
		...
		try {
			...
			throw new RuntimeException(
                ...
                "now in AsukaOrmAndroid models, as the process to " +
