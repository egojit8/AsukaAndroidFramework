...
package com.asuka.android.asukaandroid.http.client;
...
import com.asuka.android.asukaandroid.http.client.entity.UploadEntity;
import com.asuka.android.asukaandroid.http.client.util.URIBuilder;
...
public class HttpRequest extends HttpRequestBase implements HttpEntityEnclosingRequest {
    ...
    public void setRequestParams(EGRequestParams param) {
        if (param != null) {
            if (uriCharset == null) {
                uriCharset = Charset.forName(param.getCharset());
            }
            List<EGRequestParams.HeaderItem> headerItems = param.getHeaders();
            if (headerItems != null) {
                for (EGRequestParams.HeaderItem headerItem : headerItems) {
    ...
    public void setRequestParams(EGRequestParams param, RequestCallBackHandler callBackHandler) {
        if (param != null) {
            if (uriCharset == null) {
                uriCharset = Charset.forName(param.getCharset());
            }
